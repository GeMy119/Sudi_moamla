...
@Component({
  selector: 'app-visas-review-search',
  imports: [CommonModule, FormsModule],
  templateUrl: './visas-review-search.component.html',
  styleUrl: './visas-review-search.component.css'
})
export class VisasReviewSearchComponent {
  ...
  onSubmit(): void {
    ...
    this.iqamaService.search(this.identityNumber.trim(), this.sourceNumber.trim()).subscribe({
      next: () => {
        this.loading = false;
        this.router.navigate(['/visas-review-inquiry/result'], {
          queryParams: {
